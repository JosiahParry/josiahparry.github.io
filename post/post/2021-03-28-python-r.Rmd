...
knitr::include_graphics("/post/2021-03-28-python-r_files/aapl-stock.png", error = FALSE)
```
...
knitr::include_graphics("https://user-images.githubusercontent.com/13534508/112771576-7c9a1200-8ffa-11eb-9be1-87a0a617ed23.png")
```
