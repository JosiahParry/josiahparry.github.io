...
Getting lyrics to a single song is pretty easy. Let's get in our **ELEMENT.** and checkout **DNA.** by _Kendrick Lamar_. But first, note that the `genius_lyrics()` function takes two main arguments, `artist` and `song`. Be sure to spell the name of the artist and the song correctly.
